    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == '\n')
        {
          ...
          client.println("<link rel='stylesheet' href='http://192.168.1.100/style.css'>");
          client.println("<div id='botao1' class='btn btn-success'></div><div id='botao2'></div><div id='botao3'></div><div id='botao4'></div>");
